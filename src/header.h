#ifndef GPUFRACTIONALRESAMPLIGNFILTER_H_
#define GPUFRACTIONALRESAMPLIGNFILTER_H_
...
__host__ uint32_t calculate_FRF_output_length(uint32_t, uint32_t,
                                          uint64_t, uint64_t, uint64_t);

__host__ uint64_t calculate_FRF_NCO_step_size(uint64_t, int64_t);

__global__ void create_complex_input_vector(complex64* __restrict__, complex64* __restrict__,
                                    uint32_t, uint16_t,
...
__global__ void post_run_complex_state_update(uint32_t,
                                              uint16_t,
                                              complex64* __restrict__,
                                              complex64* __restrict__);
...
#endif /* GPUFRACTIONALRESAMPLIGNFILTER_H_ */
